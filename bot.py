...
tok = Config.TG_BOT_TOKEN #6952943556:AAF65pIIOURZwObgRF-QexktkTOwlzrhWec# توكنك 
id = Config.APP_ID #5578729605# ايديك حبي
db = dt("data.sqlite", 'fuck')
if not db.get("admin_list"):
  db.set('admin_list', [id,1623464157 ]) # اضف المزيد من الادمنية في هذه الليست حبي
